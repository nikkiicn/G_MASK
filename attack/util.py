...
def get_log_filename(args):
    filename = "{h}x{w}, alpha={alpha}, beta={beta} {n_models}models, {epochs}epochs, lr={lr:.1e}, batch_size={bs}".format(
        alpha=args.alpha,beta=args.beta, n_models=len(args.backbone_net), epochs=args.epochs, lr=args.lr,
