...
from mf_attack.nets.facenet import Facenet as facenet
from mf_attack.utils.utils import preprocess_input, resize_image, show_config
...
class Facenet(object):
    ...
    def det_im(self, data):
        ...
        with torch.no_grad():
            ...
            l = np.linalg.norm(output, axis=1)


        # plt.subplot(1, 2, 1)
        # plt.imshow(np.array())
        # plt.text(-12, -12, 'Distance:%.3f' % output, ha='center', va='bottom', fontsize=11)
        # plt.show()
        return l
